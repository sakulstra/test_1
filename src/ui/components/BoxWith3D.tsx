  ...
  if (withActions) {
    return (
      <Box
        sx={{
          position: 'relative',
          pb: borderSizeVariants(borderSize, 'default'),
          pl: borderSizeVariants(borderSize, 'default'),
          [theme.breakpoints.up('sm')]: {
            pb: borderSizeVariants(borderSize, 'sm'),
      ...
      <InitialBox
        ...
        <Box
          ...
          sx={{
            ...
            width:
              isDisabled && onHeader
                ? `calc(100% + ${borderSizeVariants(borderSize, 'default')}px)`
                : '100%',
            ...
            [theme.breakpoints.up('sm')]: {
              width:
                isDisabled && onHeader
                  ? `calc(100% + ${borderSizeVariants(borderSize, 'sm')}px)`
                  : '100%',
              transform: isDisabled
                ? `translate(-${borderSizeVariants(
                    borderSize,
