...
export const getDesignTokens = (mode: 'light' | 'dark') => {
  ...
  return {
    ...
    palette: {
      ...
      $disabled: getColor('#C6C3D1', '#383E53'),
      ...
      $textDisabled: getColor('#C6C3D1', '#3C455E'),
      $textWhite: getColor('#FFFFFF', '#FFFFFF'),
      $textLight: getColor('#FFFFFF', '#ADAECF'),
      ...
      $secondaryBorder: getColor('#555069', '#5C6279'),
      $disabledBorder: getColor('#C6C3D1', '#3C455E'),
      $backgroundOverlap: getColor('#292E4199', '#292E4199'),
