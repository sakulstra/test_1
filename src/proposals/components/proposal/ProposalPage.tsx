...
import { ProposalAdminActions } from './ProposalAdminActions';
...
export function ProposalPage({
  ...
  const Timeline = () => {
    ...
    return (
      <NoSSR>
        <ProposalTimeline
          proposalCreationTime={proposal.data.creationTime}
          proposalExpirationTime={
            proposal.data.basicState === BasicProposalState.Executed
              ? predictPayloadExpiredTime
              : proposal.timings.expirationTime
          }
        ...
        <Box
          ...
          <Box
            ...
            <ProposalVoteInfo
              ...
              statusTimestamp={
                isFinished ? stateTimestamp : timestampForEstimatedState
              }
              status={proposal.state}
              voters={votersForCurrentProposal}
            />
            ...
            <NoSSR>
              <>
                ...
                {!isFinished && (
                  <ProposalAdminActions proposalId={proposal.data.id} />
                )}
              </>
            </NoSSR>
          </Box>
